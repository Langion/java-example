...
import * as ServicebGraphql from "../graphql/Serviceb";
...
export const HotelController = new graphql.GraphQLObjectType({
  ...
  fields: {
    getAllHotel: {
      ...
      type: RemainGraphql.Page(false, ServicebGraphql.Hotel(false)),
      args: {
    ...
    getHotel: {
      ...
      type: ServicebGraphql.Hotel(false),
      args: {
    ...
    getHotelTwo: {
      ...
      type: ServicebGraphql.HotelTwo(false),
      args: {
...
export const HotelControllerMutation = new graphql.GraphQLObjectType({
  ...
  fields: {
    createHotel: {
      ...
      type: Raw,
      args: {
        payload: { type: new graphql.GraphQLNonNull(ServicebGraphql.Hotel(true)) },
      },
      resolve: (source: any, args: any, c: any, info: any) =>
