package com.aspirisen.servicea.api.rest;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;
import io.swagger.annotations.ApiParam;

import com.aspirisen.servicea.domain.Hotel;
import com.aspirisen.servicea.domain.TestAHotel;
import com.aspirisen.servicea.exception.DataFormatException;
import com.aspirisen.servicea.service.HotelService;
...
@RestController
@RequestMapping(value = "/example/v1/a/test")
@Api(tags = { "hotels" })
public class TestAController extends AbstractRestHandler {
        ...
        public void createHotel(@RequestBody Hotel hotel, HttpServletRequest request, HttpServletResponse response) {
                ...
                response.setHeader("Location",
                                request.getRequestURL().append("/").append(createdHotel.getId()).toString());
        }
