package com.aspirisen.serviceb.api.rest;

import io.swagger.annotations.Api;
import io.swagger.annotations.ApiOperation;
import io.swagger.annotations.ApiParam;

import com.aspirisen.serviceb.domain.Hotel;
import com.aspirisen.serviceb.domain.HotelTwo;
import com.aspirisen.serviceb.exception.DataFormatException;
import com.aspirisen.serviceb.service.HotelService;
...
public class HotelController extends AbstractRestHandler {
    ...
    public
    @ResponseBody
    HotelTwo getHotelTwo(@ApiParam(value = "The ID of the hotel.", required = true)
                             @PathVariable("id") Long id,
                             HttpServletRequest request, HttpServletResponse response) throws Exception {
        return null;
    }
